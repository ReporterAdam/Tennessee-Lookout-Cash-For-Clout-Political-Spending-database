/* ─────────────────────────────────────────────────────────────────────────────
   ...
   Independent expenditures module:
     - Spenders tab (default): who spent the money + who funded them
     - Politicians tab: who money was spent on
   Changes from v1:
     - Spenders shown first
     - 2026 races filter removed
     - Era labels show years not "All Years"
     - Default era is 2022
───────────────────────────────────────────────────────────────────────────── */
...
window.TNIE = (function () {
  ...
  const PAGE_SIZE = 50;
  const ERA_OPTS  = [['2012','Since 2012'],['2017','Since 2017'],['2022','Since 2022'],['2025','Since 2025']];

  function getEra(state) {
    return state.era || '2022';   // default 2022
  }
  ...
  async function render(container, state, helpers) {
    ...
    // Default subview is spenders (not politicians)
