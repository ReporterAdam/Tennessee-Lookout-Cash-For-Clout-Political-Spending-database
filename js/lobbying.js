  ...
  async function render(container, state, helpers) {
    ...
    container.innerHTML = `
      <div class="tn-methodology">
        <strong>About this data:</strong> Reported semi-annually to the Tennessee Bureau of Ethics
        and Campaign Finance. Because the state records spending in ranges, figures shown are midpoint
        ...
        <div class="tn-profile-body">
          ...
          ${compDetail.length ? `
            ...
            <div class="tn-table-wrap" style="margin-bottom:20px;">
              <table class="tn-table">
                <thead><tr><th>Year</th><th class="num">Amount</th></tr></thead>
                <tbody>
                  ${compDetail.map(r => `
                    <tr>
                      <td>${r.year}</td>
